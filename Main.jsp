...
<html>
  ...
  <body>
    <h1><a href="Main.html" class="a_head">Stageus Calendar</a></h1>

    <div class="container">
      <div class="content">
        <ul>
          <h3>사용자 정보</h3>
          <li>이름: <a href="GetInfo.jsp" class="atag_in_list"><%=name%></a> 안녕하세요</li>
          <li>이메일: <a href="GetInfo.jsp" class="atag_in_list"><%=email%></a></li>
          <li>부서: <a href="GetInfo.jsp" class="atag_in_list"><%=part%></a></li>
        </ul>
      ...
      <main class="main_section">
        ...
        <div class="subsection">
          ...
          <div class="add_schedule">
            <img class="cal_pic" src="달력.png" alt="" />
